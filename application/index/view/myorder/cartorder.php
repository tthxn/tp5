                                    ...
                                    <div class="m-addressAdd">
                                        ...
                                        <div class="m-operateButtons f-left">
                                            <div class="w-row-addr w-row-addr-1">
                                                <div class="w-col-1">
                                                    <div class="w-chkbox">
                                                        <input type="checkbox" name="is_default" value="0" class="j-checkbox setdefault">
                                                        <span>设为默认</span>
                                                    </div>
                                                </div>
                                    ...
                                    <td class="m-itemPriceTd">
                                        <div class="tdWrap">
                                            <div class="priceWrap">
                                                <p class="retailPrice">
                                                    <span>¥</span>
                                                    <span>{$oneArr['price']}</span></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="m-itemCountTd">
                                        <div class="tdWrap">{$oneArr['num']}</div>
                                    </td>
                                    <td>
                                        <div class="tdWrap">{$oneArr['total']}</div>
                                    </td>
                                    <td>
                                        <textarea id="{$k}" name="remarks[{$k}]" style="border: 1px solid #c0c0c0;height:100px"></textarea>
                                    </td>
                                </tr>
                                <?php endforeach;?>
                                </tbody>
...
//               //异步添加
            ...
            var setDefaults = $('.setdefault').attr('value');
//            alert(setDefaults);
...
//         console.log(formData);
            $.ajax({
                ...
                type: 'post',
                //序列化的数据不用使用json格式传输
                data: formData+'&is_default='+setDefaults,
