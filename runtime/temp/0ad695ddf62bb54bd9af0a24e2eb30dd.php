<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"F:\www\thinkphp\public/../application/index\view\index\lists.php";i:1506569931;s:57:"F:\www\thinkphp\public/../application/index\view\base.php";i:1507906367;}*/ ?>
<!DOCTYPE html>
<html class="no-js">
<head>
...
<div class="g-bd-list">
    <div class="g-row">
        ...
        <div class="m-crumbs ">
            ...
            <span class="z-cur"><?php echo $name['name']; ?></span>
        </div>
                                ...
                                <div class="m-product j-product ">
                                    ...
                                    <div class="hd">
                                        <a href="/content/<?php echo $v['id']; ?>" title="<?php echo $v['name']; ?>" target="_blank">
                                            <img src="<?php echo $v['list_image']; ?>" alt="<?php echo $v['name']; ?>" class="img img-lazyload j-lazyload ">
                                            <span></span>
                                            <span></span>
                                        </a>
                                    </div>
