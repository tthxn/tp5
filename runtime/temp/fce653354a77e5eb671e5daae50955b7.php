<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"F:\www\thinkphp\public/../application/index\view\order\index.php";i:1506415157;s:57:"F:\www\thinkphp\public/../application/index\view\base.php";i:1507906367;}*/ ?>
<!DOCTYPE html>
<html class="no-js">
<head>
...
<!--                                新建地址，地址填写表单-->
                ...
                <noscript></noscript>
                <form action="/confirm/<?php echo $gInfo['gid']; ?>/<?php echo $gInfo['aid']; ?>" method="post">
                                    ...
                                    <td class="m-itemPriceTd">
                                        <div class="tdWrap">
                                            <div class="priceWrap">
                                                <p class="retailPrice">
                                                    <span>¥</span>
                                                    <span><?php echo $gInfo['price']; ?></span></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="m-itemCountTd">
                                        <div class="tdWrap"><?php echo $gInfo['number']; ?></div>
                                    </td>
                                    <td>
                                        <div class="tdWrap"><?php echo $gInfo['totalPrice']; ?></div>
                                    </td>
                                    <td>
                            ...
                            <div>
                                <div>
                                    <div class="tt">
                                        ...
                                        <span><?php echo $gInfo['totalPrice']; ?></span>
                                    </div>
                                    <br>
                                    <div class="tt">
                                        <label>
                                        ...
                                        <span><?php echo $gInfo['number']; ?></span>
                                        <span>件</span>
                                    </div>
                                    <br>
                                    <div class="tt">
                    ...
                    <input type="text" hidden value="<?php echo $gInfo['number']; ?>" name="num">
