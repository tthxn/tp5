<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"F:\www\thinkphp\public/../application/index\view\myorder\index.php";i:1506498207;s:57:"F:\www\thinkphp\public/../application/index\view\base.php";i:1507906367;}*/ ?>
<!DOCTYPE html>
<html class="no-js">
<head>
                                    ...
                                    <table class="m-orderItem" cellpadding="0">
                                        ...
                                        <tr class="head">
                                            ...
                                            <span class="dealtime">
                                                ...
                                                <span class="number">
                                                <span>订单号：</span>
                                                <span><?php echo $v['order_number']; ?></span>
                                            </span>
                                        ...
                                        <tr class="body">
                                                    ...
                                                    <div class="packageItem">
                                                        <div class="good">
                                                            <?php foreach ($aa as $value):if ($value['id'] == $v['id']): ?>
                                                                <a class="link" href="/content/<?php echo $value['gid']; ?>"
                                                                   target="_blank">
                                                                    <img src="<?php echo $value['list_image']; ?>" width="100px"
                                                                         height="100px">
                                                                </a>

                                                            <?php endif;endforeach; if (count($orderslist[$v['id']]) == 1): ?>
                                                                <div class="info">
                                                                    <?php foreach ($goods as $gvalue) {
                                                                        if ($gvalue['id'] == $orderslist[$v['id']][0]['goods_id']) { ?>
                                                                            <a class="f-fz14"
                                                                               href="/content/<?php echo $gvalue['id']; ?>"
                                                                               target="_blank" title="">
                                                        ...
                                                        <div class="status">
                                                            <div class="cell">
                                                                <div><?php echo $v['order_status']; ?></div>
                                                                <span></span>
                                                                <span></span>
                                            ...
                                            <td>
                                                <div class="f-txtcenter">
                                                    <span></span>
                                                    <a class="w-link" href="/myorder/<?php echo $v['id']; ?>">查看详情</a>
                                                    <span></span>
                                                    <span></span>
                                                    <span></span>
                                                </div>
